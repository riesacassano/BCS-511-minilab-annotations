...
* intact_2 (seconds 79-158) contains boundaries at 79,95,111,127,143 aka 17,33,49,65
...
In the generated csv (`ground_truth_phrase_boundaries.csv`), phrase boundaries (intact, 8B) and pseudo-phrase boundaries (2B, 1B) are marked at the end of the phrase, with a 1 in the last second of the phrase (0 elsewhere).
...
pb %>%
  ...
  #write_csv('data/ground_truth_phrase_boundaries.csv')
  print()
