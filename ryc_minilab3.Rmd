...
It seems like there's more variability in response rate in the 1B and 2B conditions compared to the 8B and intact. One way to explore consistency across subjects is by correlating response rates by subjects across conditions. Subjects with higher rates in 1B are expected to have higher rates in intact relative to other subjects. In a linear model, a non-zero intercept would suggest an effect of condition on response rate. Significant correlation between two conditions could point to some intrinsic, subject-specific rate.
