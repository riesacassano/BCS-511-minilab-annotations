...
compute_null_dist <- function(data, stim, n_samples) {
  ...
  for (sub in seq(n_subj)){
    # create array (n_subj x n_samples) or transpose then take mean over subjects
  }
...
compare_true_to_null <- function(data, stim, n_samples){
  ...
  compute_null_dist(data, stim, n_samples)
...
compare_true_to_null(data_long,test_stim,2)
