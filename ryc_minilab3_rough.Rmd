...
p_r1
#ggsave("plots/raster_resp_run1.png", plot = p_r1)
...
p_r2
#ggsave("plots/raster_resp_run2.png", plot = p_r2)
```
...
p_sum_resp1
#ggsave("plots/sum_resp_run1.png", plot = p_sum_resp1)
...
p_sum_resp2
#ggsave("plots/sum_resp_run2.png", plot = p_sum_resp2)
```


Comparing lags across conditions
- generate lag data in python and save
